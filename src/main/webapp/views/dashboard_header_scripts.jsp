  ...
  <body>
    <div class="app-layout mdl-layout mdl-js-layout mdl-layout--fixed-drawer mdl-layout--fixed-header">
	  ...
	  <c:set var="sessionUserDspName" value="Test User" /><c:if test="${not empty sessionScope.ssnUserDispName}"><c:set var="sessionUserDspName" value="${sessionScope.ssnUserDispName}" /></c:if>
