...
public class UserDetail implements Serializable {
	...
	public UserDetail(String userName, String password, String emailId, Long invalidInd, String userRole) {
	...
	public Long getUserInd() {
		return this.userInd;
	}

	public void setUserInd(Long userInd) {
