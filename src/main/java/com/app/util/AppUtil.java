...
public class AppUtil {
	...
	/**
     * This method is used to check whether an object is null. Returns true if
     * the object is null and return false otherwise.
     * 
     * @param pObj
    ...
    /**
     * This method is used to check whether an object is not null. Returns true
     * if the object is not null and return false otherwise.
     * 
     * @param pObj
     *            The object to be validated.
     * @return Returns a boolean value.
    ...
    public static ModelAndView rediredtedTo(String pageName){
    	return new ModelAndView (isNotNull(pageName)? "redirect:"+pageName : "redirect:/");
    }
    
    public static ModelAndView forwaredTo(String pageName){
    	return new ModelAndView (isNotNull(pageName)? "forward:"+pageName : "forward:/");
    }
    
    public static ModelAndView goTo(String pageName){
    ...
    public static Locale getLocale(Locale locale,String lang){
    	if(!isNull(lang)){
    		...
    		return (!isNull(locale) ? locale :
    					new Locale(AppConstants.LANGUAE_ENGLISH, AppConstants.COUNTRY_INDIA));
    	}
    }
    ...
    public static String getTokenString(){
    	...
    	try{
    		...
    		byte[] keys		= new byte[15]; secureRandom.nextBytes(keys);
    ...
    public static File getFile(String fileName){
		...
		try{
			...
			htmlFile	= new File(classLoader.getResource(fileName).getFile());
		}catch(Exception ex){
			logger.error(ex);
		}
		return htmlFile;
	...
	public static String getUserRegVerifyUrl(String token,String userMail,String tmpToken){
		String appUrl = AppConstants.HTTP_PREFIX + AppConstants.APP_SERVER_HOST 
				+ AppConstants.COLON + AppConstants.APP_SERVER_PORT + AppConstants.FORWAREDSLASH 
				+ AppConstants.APP_NAME + AppConstants.FORWAREDSLASH + AppConstants.NEW_USER_VERIFICATION_STRING + AppConstants.QUESTION_MARK
	...
	public static String getUserLoginUrl(){
		String appUrl = AppConstants.HTTP_PREFIX + AppConstants.APP_SERVER_HOST 
				+ AppConstants.COLON + AppConstants.APP_SERVER_PORT + AppConstants.FORWAREDSLASH 
				+ AppConstants.APP_NAME + AppConstants.URL_LOGIN ;
		return appUrl;
	}
