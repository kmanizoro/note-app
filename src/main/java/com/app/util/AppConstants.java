...
public class AppConstants {
	...
	public static final String MAIL_SMTP_SERVER = "<User_Mail_SMTP_Server>";
	public static final String MAIL_FROM_USER 	= "<User_Mail_Account>";
	public static final String MAIL_FROM_PASS 	= "<User_Mail_Pass>";
	...
	//Db Configuration
	public static final String DB_SERVER		= "<USER_Database_Server>";
	public static final String DB_SERVER_PORT	= "<server_port>";
	public static final String DB_USER_NAME		= "<server_user>";
	public static final String DB_USER_PASS		= "<server_user_password>";
	...
	//email verification
	public static final String APP_SERVER_HOST = "<Server>";
	public static final String APP_SERVER_PORT = "<port>";
	public static final String APP_NAME 	   = "<app_prefix>";
